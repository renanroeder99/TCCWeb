...
<div id="caixa-cadastro-externa">
    <div id="caixa-cadastro-interno">
        ...
        <div class="input-div">
            <input id="ocorrência-corpo_de_bombeiros-rua" type="text" value="Digite o Endereço" onfocus="this.value='';" />
        </div>


        <div class="input-div">
            <input id="ocorrencia-corpo_de_bombeiros-numero-residencia" type="text" value="N° Residência" onfocus="this.value='';" />
        </div>


        <div class="input-div">
            <input id="ocorrencia-corpo_de_bombeiros-cep" value="Digite o Cep" type="text" onfocus="this.value='';"/>
        </div>


        <div class="input-div">
            <textarea cols=80 id="ocorrencia_corpo_de_bombeiros-descricao" rows="10" name="opiniao" maxlength="500" wrap="hard" placeholder="Digite uma breve descrição do acontecimento! "></textarea>
        </div>
        <div class="input-div">
