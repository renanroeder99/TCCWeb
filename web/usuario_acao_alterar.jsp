...
<%
    ...
    emissor.setId(Integer.parseInt(request.getParameter("usuario-id")));
    ...
    emissor.setCep(request.getParameter("usuario-cep"));
    ...
    emissor.setTelefone(request.getParameter("usuario-telefone"));
